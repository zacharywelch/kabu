...
(function ($) {
  ...
  var defaults = {
    ...
    tagsContainer: null,
    tagCloseIcon: 'x',
    tagClass: 'dark pad0 small round inline space-bottom0',
    validator: null,
    onlyTagList: false,
    tagList: null,
  ...
  publicMethods = {
    pushTag: function (tag, ignoreEvents, externalTagId) {
      ...
      if (alreadyInList) {
        ...
        html += '<button href="#" class="close" id="' + newTagRemoveId + '" TagIdToRemove="' + tagId + '">';
        html += opts.tagCloseIcon + '</button></span> ';
        $el = $(html);
